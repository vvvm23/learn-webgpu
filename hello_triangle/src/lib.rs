...
struct State<'a> {
    ...
    // declare window after so it gets dropped last
    window: &'a Window,
}
...
impl<'a> State<'a> {
    ...
    fn input(&mut self, event: &WindowEvent) -> bool {
        // TODO: handling basic inputs (eg. quit)
        todo!()
    }
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        // TODO: actual render step. Basically the render pass
        todo!()
    }
}
                ...
                match event {
                    ...
                    WindowEvent::RedrawRequested => {
                            ...
                            });
                        {
                            ...
                            rpass.draw_indexed(0..(index_data.len() as u32), 0, 0..3);
                        }
